...
public class Queue<E> {
	...
	public boolean dequeue(Customer c) throws NoSuchElementException {
		System.out.println("Customer " + c.getCustomerId() + " has left self checkout.");
		queueList.remove(c);
		...
		System.out.println("Customer " + b.getCustomerId() + " is now at the front of the self checkout queue.");
